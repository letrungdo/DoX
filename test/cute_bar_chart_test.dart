...
void main() {
  ...
  testWidgets('renders single-series daily chart and handles taps', (
    tester,
  ) async {
    ...
    await tester.tapAt(
      tester.getTopLeft(find.byType(CustomPaint).last) + const Offset(5, 50),
    );
    await tester.pump();
    expect(tester.takeException(), isNull);
  ...
  testWidgets('renders grouped monthly chart with compare series', (
    tester,
  ) async {
    final items = List.generate(
      12,
