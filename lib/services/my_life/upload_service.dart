...
class UploadService {
  ...
  static const uploadHeaders = {
    ...
    'user-agent': 'com.mylife.MyLife/1.121.1 iPhone/18.3.2 hw/iPhone17_3 (GTMSUF/1)',
  };
  ...
  Future<String> _initUploadImage({
    ...
    final response = await dio.post(
      "https://firebasestorage.googleapis.com/v0/b/mylife-img/o/users%2F$idUser%2Fmoments%2Fthumbnails%2F$imgName?uploadType=resumable&name=users%2F$idUser%2Fmoments%2Fthumbnails%2F$imgName".withProxy(), //
      data: body,
      options: Options(
        headers: {
  ...
  Future<String> _initUploadVideo({
    ...
    final response = await dio.post(
      "https://firebasestorage.googleapis.com/v0/b/mylife-video/o/users%2F$idUser%2Fmoments%2Fvideos%2F$videoName?uploadType=resumable&name=users%2F$idUser%2Fmoments%2Fvideos%2F$videoName".withProxy(), //
      data: body,
      options: Options(
        headers: {
          'content-type': 'application/json; charset=UTF-8',
          ...
          'user-agent': 'com.mylife.MyLife/1.43.1 iPhone/17.3 hw/iPhone15_3 (GTMSUF/1)',
  ...
  Future<String> _getDownloadImageUrl({
    ...
    final getUrl = "https://firebasestorage.googleapis.com/v0/b/mylife-img/o/users%2F${user.localId}%2Fmoments%2Fthumbnails%2F$imgName".withProxy();
  ...
  Future<String> _getDownloadVideoUrl({
    ...
    final getUrl = "https://firebasestorage.googleapis.com/v0/b/mylife-video/o/users%2F${user.localId}%2Fmoments%2Fvideos%2F$videoName".withProxy();
