...
class UploadService {
  ...
  Future<String> _getDownloadImageUrl({
    ...
    final getUrl = "https://firebasestorage.googleapis.com/v0/b/mylife-img/o/users%2F${user.localId}%2Fmoments%2Fthumbnails%2F$imgName";
  ...
  Future<String> _getDownloadVideoUrl({
    ...
    final getUrl = "https://firebasestorage.googleapis.com/v0/b/mylife-video/o/users%2F${user.localId}%2Fmoments%2Fvideos%2F$videoName";
