...
class AppViewModel extends CoreViewModel {
  ...
  bool _showMyLifeTab = storageService.getShowMyLifeTab();
  bool get showMyLifeTab => _showMyLifeTab;
  ...
  void setShowMyLifeTab(bool value) {
    _showMyLifeTab = value;
    notifyListeners();
    storageService.setShowMyLifeTab(value);
  }
