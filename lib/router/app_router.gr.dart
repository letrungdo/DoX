...
import 'package:do_x/screen/myLife/my_life_screen.dart' as _i8;
import 'package:do_x/screen/myLife/login_screen.dart' as _i9;
...
/// generated route for
/// [_i8.MyLifeScreen]
class MyLifeRoute extends _i16.PageRouteInfo<void> {
  const MyLifeRoute({List<_i16.PageRouteInfo>? children})
  ...
  static _i16.PageInfo page = _i16.PageInfo(
    name,
    builder: (data) {
      return _i16.WrappedRoute(child: const _i8.MyLifeScreen());
    },
  );
}
