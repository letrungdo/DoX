...
import 'package:do_x/screen/myLife/trimmer_screen.dart' as _i12;
...
/// generated route for
/// [_i6.MyLifeScreen]
class MyLifeRoute extends _i13.PageRouteInfo<void> {
  const MyLifeRoute({List<_i13.PageRouteInfo>? children})
  ...
  static _i13.PageInfo page = _i13.PageInfo(
    name,
    builder: (data) {
      return _i13.WrappedRoute(child: const _i6.MyLifeScreen());
    },
  );
}
