...
import 'package:do_x/screen/myLife/my_life_screen.dart' as _i6;
import 'package:do_x/screen/myLife/login_screen.dart' as _i7;
import 'package:do_x/screen/myLife/trimmer_screen.dart' as _i11;
...
/// generated route for
/// [_i6.MyLifeScreen]
class MyLifeRoute extends _i12.PageRouteInfo<void> {
  const MyLifeRoute({List<_i12.PageRouteInfo>? children})
  ...
  static _i12.PageInfo page = _i12.PageInfo(
    name,
    builder: (data) {
      return _i12.WrappedRoute(child: const _i6.MyLifeScreen());
    },
  );
}
