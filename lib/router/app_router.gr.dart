...
import 'package:do_x/screen/my_life_screen.dart' as _i2;
...
/// generated route for
/// [_i2.MyLifeScreen]
class MyLifeRoute extends _i6.PageRouteInfo<void> {
  const MyLifeRoute({List<_i6.PageRouteInfo>? children})
  ...
  static _i6.PageInfo page = _i6.PageInfo(
    name,
    builder: (data) {
      return _i6.WrappedRoute(child: const _i2.MyLifeScreen());
    },
  );
}
