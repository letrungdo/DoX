...
import 'package:do_x/screen/myLife/my_life_screen.dart' as _i2;
import 'package:do_x/screen/myLife/login_screen.dart' as _i3;
import 'package:do_x/screen/myLife/trimmer_screen.dart' as _i7;
...
class MyLifeRoute extends _i8.PageRouteInfo<void> {
  ...
  static _i8.PageInfo page = _i8.PageInfo(
    name,
    builder: (data) {
      return _i8.WrappedRoute(child: const _i2.MyLifeScreen());
    },
  );
}
