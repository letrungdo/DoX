...
import 'package:do_x/screen/myLife/my_life_screen.dart' as _i7;
import 'package:do_x/screen/myLife/login_screen.dart' as _i8;
import 'package:do_x/screen/myLife/trimmer_screen.dart' as _i14;
...
/// generated route for
/// [_i7.MyLifeScreen]
class MyLifeRoute extends _i15.PageRouteInfo<void> {
  const MyLifeRoute({List<_i15.PageRouteInfo>? children})
  ...
  static _i15.PageInfo page = _i15.PageInfo(
    name,
    builder: (data) {
      return _i15.WrappedRoute(child: const _i7.MyLifeScreen());
    },
  );
}
