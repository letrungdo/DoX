...
class Envs {
  ...
  static const locketApiKey = PlatformValue(
    iOS: String.fromEnvironment('LOCKET_API_KEY_IOS'),
    android: String.fromEnvironment('LOCKET_API_KEY_ANDROID'),
    web: String.fromEnvironment('LOCKET_API_KEY_WEB'),
  );
