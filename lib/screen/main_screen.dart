...
class _MainScreenState extends ScreenState<MainScreen, MainViewModel> {
  ...
  void _requireLoginForInitialChickenTab(BuildContext context, TabsRouter tabsRouter, bool hasMyLifeTab) {
  ...
  Widget build(BuildContext context) {
    ...
    return Selector<AppViewModel, bool>(
      selector: (_, vm) => vm.showMyLifeTab,
      builder: (context, showMyLifeTab, _) {
        final routes = [
          const NewsRoute(),
          const ChickenRoute(),
          if (showMyLifeTab) const MyLifeRoute(),
          const MenuRoute(),
        ];

        return AutoTabsRouter(
          key: ValueKey('main-tabs-$showMyLifeTab'),
          routes: routes,
          ...
          builder: (context, child) {
            ...
            _requireLoginForInitialChickenTab(context, tabsRouter, showMyLifeTab);
            ...
            return Scaffold(
              bottomNavigationBar: BottomNavigationBar(
                ...
                items: <BottomNavigationBarItem>[
                  ...
                  if (showMyLifeTab) _navItem(Assets.images.heartCute, l10n.myLife),
