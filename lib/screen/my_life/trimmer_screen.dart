...
class _TrimmerScreenState extends State<TrimmerScreen> {
  ...
  // MyLife's storage rules reject videos >= 6 MiB with a 403 on the finalize
  ...
  Future<void> _exportVideo() async {
    ...
    // Video still over MyLife's 6 MiB limit after the default p720 compress ->
  ...
  Future<String?> _trimVideo({
    ...
    try {
      ...
      // Center-crop to a 1:1 square to match MyLife's square format.
