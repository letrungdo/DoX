...
/// The current track's video across the whole television, with the player's
/// controls laid over it.
///
/// Built for the remote. The controls come up over the picture and go away
/// again on their own, the way a television's own player behaves: any arrow
/// or OK on the bare picture brings them back with the remote on play, and
/// the transport keys a remote is printed with — play, pause, next, previous,
/// the channel pair — work whether the controls are up or not. Back leaves
/// for the track list, and the music plays on.
///
/// A bare [Scaffold] rather than `AppScaffold`: the picture bleeds to every
/// edge, and only the controls keep clear of the overscan band.
class MusicTvVideoPlayer extends StatefulWidget {
  const MusicTvVideoPlayer({
    super.key,
  ...
  @override
  State<MusicTvVideoPlayer> createState() => _MusicTvVideoPlayerState();
}

class _MusicTvVideoPlayerState extends State<MusicTvVideoPlayer> {
  ...
  void _scheduleHide() {
    _hideTimer?.cancel();
    _hideTimer = Timer(Dimens.musicTvControlsHideDelay, _hideControls);
  }
                ...
                child: ExcludeFocus(
                  ...
                  child: IgnorePointer(
                    ...
                    child: AnimatedOpacity(
                      ...
                      duration: Dimens.musicTvControlsFade,
        ...
        if (artworkUrl.isNotEmpty)
          Opacity(
            ...
            child: CachedNetworkImage(
              imageUrl: artworkUrl,
              width: Dimens.musicTvWaitingArtSize,
              height: Dimens.musicTvWaitingArtSize,
              fit: BoxFit.cover,
            ),
          ),
        const Loading(),
  ...
  Widget _buildControls(MusicViewModel vm) {
    ...
    return DecoratedBox(
      ...
      child: Padding(
        padding: Dimens.tvOverscan.copyWith(top: Dimens.musicTvControlsTop),
        child: FocusScope(
          node: _controlsScope,
          child: Column(
            ...
            children: [
              ...
              Row(
                ...
                spacing: Dimens.musicTvControlSpacing,
                children: [
                  _ControlButton(
                  ...
                  _ControlButton(
                    ...
                    tooltip: l10n.musicVideoBackToList,
                    onTap: widget.onExit,
                  ),
                ],
              ),
...
class _ControlButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final size = large
        ? Dimens.musicTvPlayButtonSize
        : Dimens.musicTvControlSize;
