      ...
      body: ListView(
        ...
        children: [
          ...
          _buildSettingCard(
            ...
            color: Colors.pink,
            title: Text(l10n.showMyLifeTab),
            trailing: Switch.adaptive(value: appVm.showMyLifeTab, onChanged: appVm.setShowMyLifeTab),
            onTap: () => appVm.setShowMyLifeTab(!appVm.showMyLifeTab),
          ),
          const SizedBox(height: 10),
          _buildSettingCard(
