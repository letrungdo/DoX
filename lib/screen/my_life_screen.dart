...
import 'package:do_x/view_model/my_life_view_model.dart';
...
@RoutePage()
class MyLifeScreen extends StatefulScreen implements AutoRouteWrapper {
  const MyLifeScreen({super.key});

  @override
  State<MyLifeScreen> createState() => _HomeScreenState();

  @override
  Widget wrappedRoute(BuildContext context) {
    return ChangeNotifierProvider(
      create: (_) => MyLifeViewModel(), //
      child: this,
    );
  }
}

class _HomeScreenState<V extends MyLifeViewModel> extends ScreenState<MyLifeScreen, V> with AutomaticKeepAliveClientMixin {
  @override
