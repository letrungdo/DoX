...
- **Locket:** sign in, capture or select photos and videos, trim videos, and add
  weather overlays.
...
- Firebase Core, Crashlytics, and Firebase APIs used by Locket
...
with, endorsed by, or sponsored by Supabase, Firebase, Locket, Central Power
